...
func GrabUsersU2FTokens(st *state.State) []u2f.Registration {
...
func GrabUsersU2FTokenByKeyHandle(st *state.State, keyHandle string) *state.U2FToken {
	for _, u2f := range st.State.U2FTokens {
